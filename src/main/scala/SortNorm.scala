...
object ArithmeticOrdering extends Ordering[SearchedWebPage] {
    ...
    def compare(a: SearchedWebPage, b: SearchedWebPage): Int = a.textmatch + a.weight / 2 compare b.textmatch + b.weight / 2
}
...
object GeometricOrdering extends Ordering[SearchedWebPage] {
    ...
    def compare(a: SearchedWebPage, b: SearchedWebPage): Int = Math.sqrt(a.textmatch * a.weight) compare Math.sqrt(b.textmatch * b.weight)
}
...
object HarmonicOrdering extends Ordering[SearchedWebPage] {
    ...
    def compare(a: SearchedWebPage, b: SearchedWebPage): Int = (2/((1/a.textmatch) + (1/a.weight))) compare (2/((1/b.textmatch) + (1/b.weight)))
}
